...
export default function ProjectsPage() {
  ...
  return (
    <>
      <PageHero eyebrow="Projects" title="Project-driven portfolio pages for salon, grocery, milk, medical, cosmetics, stationery, and e-commerce businesses" description="Each project direction has its own number, a clear category fit, and direct WhatsApp or call actions for faster client response." actions={<Link className="inline-flex min-h-12 items-center justify-center rounded-full bg-gradient-to-br from-[#172334] to-[#26415f] px-5 py-3 text-white shadow-soft transition duration-200 hover:-translate-y-0.5" href="/contact">Request Customization</Link>} />
